...
stem_out=stem(input)
A1=inception_residual_block_A(stem_out)
A2=inception_residual_block_A(A1)
A3=inception_residual_block_A(A2)
A4=inception_residual_block_A(A3)
A5=inception_residual_block_A(A4)
RA1=inception_block_reduction_A(A4)
B1=inception_residual_block_B(RA1)
B2=inception_residual_block_B(B1)
B3=inception_residual_block_B(B2)
B4=inception_residual_block_B(B3)
B5=inception_residual_block_B(B4)
B6=inception_residual_block_B(B5)
B7=inception_residual_block_B(B6)
B8=inception_residual_block_B(B7)
B9=inception_residual_block_B(B8)
B10=inception_residual_block_B(B9)
RC2=inception_block_reduction_B(B10)
C1=inception_residual_block_C(RC2)
C2=inception_residual_block_C(C1)
C3=inception_residual_block_C(C2)
C4=inception_residual_block_C(C3)
C5=inception_residual_block_C(C4)
pool=AveragePooling2D()(C5)
flat=Flatten()(pool)
FC1=Dense(4096,activation='relu')(flat)
FC2=Dropout(0.8)(FC1)
output=Dense(n_classes,activation='softmax')(FC2)

model_inception_residual=Model(inputs=input,outputs=output)
model_inception_residual.summary()


model_inception_residual.compile(loss='categorical_crossentropy',optimizer='adam',metrics=['accuracy'])
